...
Make sure your Arduino and LoRaShield are attached to the host computer via USB. Now, upload the sketch to Arduino, by selecting "Upload" which will compile and upload the sketch to the device.
